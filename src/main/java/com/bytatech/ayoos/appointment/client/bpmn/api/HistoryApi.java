...
import com.bytatech.ayoos.appointment.client.bpmn.model.CommentResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.DataResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricActivityInstanceQueryRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricDetailQueryRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricIdentityLinkResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricProcessInstanceQueryRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricProcessInstanceResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricTaskInstanceQueryRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricTaskInstanceResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.HistoricVariableInstanceQueryRequest;
...
public interface HistoryApi {
    ...
    @RequestMapping(value = "/history/historic-process-instances/{processInstanceId}/variables/{variableName}/data",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<byte[]> getHistoricProcessInstanceVariableData(@ApiParam(value = "",required=true) @PathVariable("processInstanceId") String processInstanceId,@ApiParam(value = "",required=true) @PathVariable("variableName") String variableName);
    ...
    @RequestMapping(value = "/history/historic-task-instances/{taskId}/variables/{variableName}/data",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<byte[]> getHistoricTaskInstanceVariableData(@ApiParam(value = "",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "",required=true) @PathVariable("variableName") String variableName,@ApiParam(value = "") @Valid @RequestParam(value = "scope", required = false) String scope);
