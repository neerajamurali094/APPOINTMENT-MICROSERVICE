...
import com.bytatech.ayoos.appointment.client.bpmn.model.ProcessInstanceActionRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.ProcessInstanceCreateRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.ProcessInstanceQueryRequest;
import com.bytatech.ayoos.appointment.client.bpmn.model.ProcessInstanceResponse;
import com.bytatech.ayoos.appointment.client.bpmn.model.RestIdentityLink;
...
public interface ProcessInstancesApi {
    ...
    @RequestMapping(value = "/runtime/process-instances/{processInstanceId}/variables/{variableName}",
        produces = "application/json", 
        method = RequestMethod.PUT)
    ResponseEntity<RestVariable> updateProcessInstanceVariable(RestVariable variable, @ApiParam(value = "The id of the process instance to the variables for.",required=true) @PathVariable("processInstanceId") String processInstanceId,@ApiParam(value = "Name of the variable to get.",required=true) @PathVariable("variableName") String variableName);
