...
import { ConsultationInfoComponent } from 'app/entities/AyoosAppointment/consultation-info/consultation-info.component';
...
describe('Component Tests', () => {
  describe('ConsultationInfo Management Component', () => {
    let comp: ConsultationInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ConsultationInfoComponent],
        providers: [
          {
        ...
        .overrideTemplate(ConsultationInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.consultationInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
