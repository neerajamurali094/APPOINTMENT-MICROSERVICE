...
import com.bytatech.ayoos.appointment.repository.SymptomRepository;
import com.bytatech.ayoos.appointment.repository.search.SymptomSearchRepository;
import com.bytatech.ayoos.appointment.service.SymptomService;
import com.bytatech.ayoos.appointment.service.dto.SymptomDTO;
import com.bytatech.ayoos.appointment.service.mapper.SymptomMapper;
import com.bytatech.ayoos.appointment.web.rest.SymptomResource;
...
public class SymptomResourceIntTest {
    ...
    private static final Integer DEFAULT_NUMBER_OF_DAYS_SUFFERING = 1;
    private static final Integer UPDATED_NUMBER_OF_DAYS_SUFFERING = 2;
     ...
     *
     * @see com.bytatech.ayoos.appointment.repository.search.SymptomSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Symptom createEntity(EntityManager em) {
        Symptom symptom = new Symptom()
            .ref(DEFAULT_REF)
            .numberOfDaysSuffering(DEFAULT_NUMBER_OF_DAYS_SUFFERING);
        return symptom;
    }
    ...
    public void createSymptom() throws Exception {
        ...
        assertThat(testSymptom.getRef()).isEqualTo(DEFAULT_REF);
        assertThat(testSymptom.getNumberOfDaysSuffering()).isEqualTo(DEFAULT_NUMBER_OF_DAYS_SUFFERING);
    ...
    public void getAllSymptoms() throws Exception {
        ...
        restSymptomMockMvc.perform(get("/api/symptoms?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberOfDaysSuffering").value(hasItem(DEFAULT_NUMBER_OF_DAYS_SUFFERING)));
    }
    ...
    public void getSymptom() throws Exception {
        ...
        restSymptomMockMvc.perform(get("/api/symptoms/{id}", symptom.getId()))
            ...
            .andExpect(jsonPath("$.numberOfDaysSuffering").value(DEFAULT_NUMBER_OF_DAYS_SUFFERING));
    }
    ...
    public void updateSymptom() throws Exception {
        ...
        updatedSymptom
            .ref(UPDATED_REF)
            .numberOfDaysSuffering(UPDATED_NUMBER_OF_DAYS_SUFFERING);
        ...
        Symptom testSymptom = symptomList.get(symptomList.size() - 1);
        assertThat(testSymptom.getRef()).isEqualTo(UPDATED_REF);
        assertThat(testSymptom.getNumberOfDaysSuffering()).isEqualTo(UPDATED_NUMBER_OF_DAYS_SUFFERING);
